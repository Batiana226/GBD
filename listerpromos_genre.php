...
?>
	...
	<form method=post action="affiche_promo_genre.php">
		...
		<br>
		<input type="checkbox" id="sexe1" name="sexe1" value="1">
  			<label for="sexe1"> Homme</label><br>
		<input type="checkbox" id="sexe2" name="sexe2" value="2">
  			<label for="sexe2"> Femme</label><br>
